...
import { ArrowRight, DollarSign, Clock, Image, Video } from "lucide-react";
      ...
      <div className="relative container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-muted-foreground text-lg mb-12 max-w-2xl mx-auto">
            Reach thousands of Alaskans looking for boats. No commissions, no hidden fees—just simple flat-rate pricing.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            <div className="bg-glass rounded-2xl p-6 text-center">
              ...
              <h3 className="font-display text-lg font-semibold text-foreground mb-2">$20 Standard</h3>
              <p className="text-muted-foreground text-sm">Basic boat listing</p>
            </div>
            
            <div className="bg-glass rounded-2xl p-6 text-center border-2 border-accent/50">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-accent/10 mb-4">
                <DollarSign className="w-6 h-6 text-accent" />
              </div>
              <h3 className="font-display text-lg font-semibold text-foreground mb-2">$100 Featured</h3>
            ...
            <div className="bg-glass rounded-2xl p-6 text-center">
              ...
              <p className="text-muted-foreground text-sm">Up to 5 images & 3 videos</p>
            </div>
          </div>
